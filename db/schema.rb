...
ActiveRecord::Schema.define(version: 20090817133436) do
  ...
  add_index "categories", ["profile_id"], name: "index_categories_on_profile_id", using: :btree
  ...
  add_index "items", ["position"], name: "index_items_on_position", using: :btree
  ...
  add_index "quotes", ["profile_id"], name: "index_quotes_on_profile_id", using: :btree
